            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="{{route('tour-package.index')}}"
                                aria-expanded="false"><i data-feather="map-pin" class="feather-icon"></i><span
                                    class="hide-menu">Data Wisata
                                </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{route('tour-package.create')}}"
                                aria-expanded="false"><i data-feather="plus-square" class="feather-icon"></i><span
                                    class="hide-menu">Tambah Wisata</span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{route('gallery.index')}}"
                                aria-expanded="false"><i data-feather="image" class="feather-icon"></i><span
                                    class="hide-menu">Data Galeri
                                </span></a>
                        </li>

                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{route('gallery.create')}}"
                                aria-expanded="false"><i data-feather="plus-square" class="feather-icon"></i><span
                                    class="hide-menu">Tambah Galeri
                                </span></a>
                        </li>
                        <li class="list-divider"></li>
